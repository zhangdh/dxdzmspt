  ...
  <body id="bodyid">
   <div id="p" class="easyui-panel" style="height:auto;padding:5px;" title="查询条件" iconCls="icon-search" collapsible="true">
		<form id="form_search">      	
				...
				<label>来电时间：
				<input class="Wdate" style="WIDTH: 120px; HEIGHT: 20px" type="text" name="cj_sjq" id="cx_sjq" onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" readonly="readonly"/>
				</label>
				--
				<label>
				<input class="Wdate" style="WIDTH: 120px; HEIGHT: 20px" type="text" name="cj_sjz" id="cx_sjz" onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" readonly="readonly"/>
				</label>
				当前状态:
				<label>
					<select id="zt" name="zt" style="width:120px">
			...
			<table class="table_show">
				<tr>
		     	...
		     	<tr>
					...
					<td>
						<select style="WIDTH:300px; HEIGHT: 20px" name="lb_dm" id="lb_dm" showName="内容类别">
						</select>
					</td>
					<td align="right">承办类别：</td>
					<td>
						<select  style="WIDTH:300px; HEIGHT: 20px" name="cblb_dm" id="cblb_dm" showName="承办类别" onchange=cblx(this.value)>
						</select>
					</td>
		     	</tr>
		     	<tr>
					...
					<td>
						<select style="WIDTH: 300px; HEIGHT: 20px" name="xzfl" id="xzfl" showName="性质分类">
						</select>
					</td>
					<td align="right">信息来源：</td>
					<td>
						<select   style="WIDTH: 300px; HEIGHT: 20px" name="xxly" id="xxly" showName="信息来源">
						</select>
					</td>
		     	</tr>
		     	<tr>
					...
					<td>
						<select style="WIDTH: 300px; HEIGHT: 20px" name="sfbm" id="sfbm" showName="是否保密">
						</select>
					</td>
