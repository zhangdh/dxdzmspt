...
function XiorkFlowToolBar(xiorkFlow) {
    ...
    //配置
    var configButton=new Button(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "images/xiorkflow/config.gif", "配置");
    configButton.addActionListener(new NodeConfigActionListener(this.xiorkFlow));
    configButton.setToolTipText("配置");
    this.add(configButton);
    
//
   //模板设置
    //var modelButton = new Button(XiorkFlowWorkSpace.WORK_FLOW_PATH + "images/power.gif", "模板");
    //modelButton.addActionListener(new FormModelActionListener(this.xiorkFlow));
    //��Ȩ
    //modelButton.setToolTipText("模板");
    //this.add(modelButton);

    
    //权限
    //var powerButton = new Button(XiorkFlowWorkSpace.WORK_FLOW_PATH + "images/power.gif", "\u6388\u6743");
    //powerButton.addActionListener(new PowerActionListener(this.xiorkFlow));
    //��Ȩ
    //powerButton.setToolTipText("授权");
    //this.add(powerButton);
    //条件
    //var conditionButton = new Button(XiorkFlowWorkSpace.WORK_FLOW_PATH + "images/power.gif", "条件");
    //conditionButton.addActionListener(new ConditionActionListener(this.xiorkFlow));
    //conditionButton.setToolTipText("条件");
    //this.add(conditionButton);
    
    //功能按钮
    //var functionButton = new Button(XiorkFlowWorkSpace.WORK_FLOW_PATH + "images/power.gif", "功能按钮");
    //functionButton.addActionListener(new FunctionActionListener(this.xiorkFlow));
    //functionButton.setToolTipText("功能按钮");
    //this.add(functionButton);
    //表单权限设置
    //var formButton = new Button(XiorkFlowWorkSpace.WORK_FLOW_PATH + "images/power.gif", "表单设置");
    //formButton.addActionListener(new FormActionListener(this.xiorkFlow));
    //formButton.setToolTipText("表单设置");
    //this.add(formButton);
    //
