...
function MetaNode(model, img, wrapper) {
   ...
   // this.setId(2);
    ...
    //this.titleTxtCell.style.color="red";
    //
...
//20081217 wang 增加设置背景颜色的方法
MetaNode.prototype.setBgolor=function(color){
 this.table.bgColor=color;
}
//20081217 wang 增加得到表格的方法
MetaNode.prototype.getTable=function(){
 return this.table;
}
