 ...
 * @author xio
 */
function XiorkFlowTableViewerTest(model, ui) {
...
XiorkFlowTableViewerTest.prototype = new ScrollPanel();
XiorkFlowTableViewerTest.prototype.setModel = function (model) {
    if (!model) {
        return;
    }
    if (this.model == model) {
...
XiorkFlowTableViewerTest.prototype.getModel = function (model) {
    return this.model;
};
XiorkFlowTableViewerTest.prototype.update = function (observable, arg) {
...
//
XiorkFlowTableViewerTest.prototype.init = function () {
	//clear
    this.clearTable();
...
XiorkFlowTableViewerTest.prototype.addMetaNodeModel = function (metaNodeModel) {
    if (!metaNodeModel) {
        return;
    }
    var row = this.addRow();
...
XiorkFlowTableViewerTest.prototype.addRow = function () {
    var row = this.table.insertRow();
    this.rows.add(row);
    return row;
};
XiorkFlowTableViewerTest.prototype.clearTable = function () {
    Toolkit.clearElement(this.table);
    this.rows.clear();
};
XiorkFlowTableViewerTest.prototype.removeRow = function (row) {
    if (!row) {
        return;
    }
