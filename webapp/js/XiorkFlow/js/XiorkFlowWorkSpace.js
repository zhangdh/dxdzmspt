...
//
XiorkFlowWorkSpace.BASE_PATH = sys_ctx+"/";

//
XiorkFlowWorkSpace.XIORK_FLOW_PATH = XiorkFlowWorkSpace.BASE_PATH + "js/XiorkFlow/";

//
XiorkFlowWorkSpace.DEFAULT_PROCESS_NAME = "default";

//
XiorkFlowWorkSpace.URL_ADD_PROCESS = XiorkFlowWorkSpace.BASE_PATH + "oswf/graphicdesigner/default.do";
XiorkFlowWorkSpace.URL_DELETE_PROCESS = XiorkFlowWorkSpace.BASE_PATH + "deleteprocess.xf";
XiorkFlowWorkSpace.URL_GET_PROCESS = XiorkFlowWorkSpace.BASE_PATH + "oswf/graphicdesigner/default.do";
...
XiorkFlowWorkSpace.build = function () {
    ...
    //权限
    BuildLibrary.loadJS(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/xiorkflow/meta/RoleModel.js");
    ...
    // 权限 wang
   BuildLibrary.loadJS(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/xiorkflow/event/PowerActionListener.js");
    BuildLibrary.loadJS(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/xiorkflow/event/ConditionActionListener.js");
   // 功能按钮设置 wang
   BuildLibrary.loadJS(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/xiorkflow/event/FunctionActionListener.js");
   //表单权限设置 wang
   BuildLibrary.loadJS(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/xiorkflow/event/FormActionListener.js");
   //表单模板设置
   BuildLibrary.loadJS(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/xiorkflow/event/FormModelActionListener.js");
   //节点配置	
   BuildLibrary.loadJS(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/xiorkflow/event/NodeConfigActionListener.js");
    ...
    BuildLibrary.loadJS(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/xiorkflow/XiorkFlowTableViewer.js");
     //wang test
    BuildLibrary.loadJS(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/xiorkflow/XiorkFlowTableViewerTest.js");
