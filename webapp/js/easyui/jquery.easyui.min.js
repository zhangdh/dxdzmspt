...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[15,20,25,30],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_76,_77){
},onBeforeRefresh:function(_78,_79){
},onRefresh:function(_7a,_7b){
},onChangePageSize:function(_7c){

},beforePageText:"当前页",afterPageText:",共 {pages}页",displayMsg:"当前条数 {from} 至 {to}, 共 {total} 条"};
})(jQuery);
(function($){
function _7d(_7e){
var _7f=$(_7e);
