...
if (jQuery) (function($) {
    ...
    $.extend($.fn, {
        multiSelect: function(o, callback) {
            ...
            if (o.selectAllText == undefined) o.selectAllText = "全部";
            if (o.noneSelected == undefined) o.noneSelected = '请选择';
            if (o.oneOrMoreSelected == undefined) o.oneOrMoreSelected = '% 个已选择';

            // Initialize each multiSelect
            $(this).each(function() {
                var select = $(this);
                var iWidth = select.width() < 40 ? 40 : select.width();
               // var iWidth = select.width();
                //alert(iWidth);
                ...
                //
                $(select).next('.multiSelect').children('INPUT.multiSelect_txt').width(iWidth+6);
                //alert(iWidth);
                //alert($(select).next('.multiSelect').children('INPUT.multiSelect_txt').width());
                $(select).next('.multiSelect').children('INPUT.multiSelect_txt').focus(function() {
        ...
        multiSelectOptionsShow: function() {
            ...
            //comment out this statement 
           	...
           	//根据文本框宽度设置,使列表框宽度不小于文本框宽度
            if($(this).next(".multiSelectOptions").width()<$(this).children('INPUT.multiSelect_txt').width()+24){
            	$(this).next(".multiSelectOptions").css({width: $(this).width() + 32});
            }
            //alert($(this).children('INPUT.multiSelect_txt').width());
            //alert($(this).next(".multiSelectOptions").width());
