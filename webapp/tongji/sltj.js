...
$(function() {
	$('#datalist').datagrid({
		method:'post',
		url:webcontext+'/tjbb.coffice?method=sltj&page_num='+page_num,
		rownumbers:true,
		remoteSort:true,
		fitColumns: true,
		columns:[[
			...
			{field:'zjdfl',title:'直接答复量',width:$(this).width() * 0.1,align:'center'},
			{field:'jbl',title:'交办量',width:$(this).width() * 0.1,align:'center'},
			{field:'yxsl',title:'有效数量',width:$(this).width() * 0.15,align:'center'},
			{field:'dqgdl',title:'当前办结归档量',width:$(this).width() * 0.15,align:'center'},
			{field:'yxl',title:'有效率',width:$(this).width() * 0.15,align:'center',formatter:yxl},
			{field:'dqbj',title:'当前办结归档率',width:$(this).width() * 0.15,align:'center',formatter:dqbj}
		]],
