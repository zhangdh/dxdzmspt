...
TToolBox.prototype.hideBox = function(){
  ...
  oImg.src = "../../../js/design/image/" + this.TitleBtn[0] + ".gif";
  oImg.title = "单击展开工具栏";
...
TToolBox.prototype.showBox = function(){
  ...
  oImg.src = "../../../js/design/image/" + this.TitleBtn[1] + ".gif";
  oImg.title = "单击收缩工具栏";
...
TToolBox.prototype.toString = function(){
  ...
  if(this.Dir == "down"){
    ...
    'ondblclick="'+this.ID+'.showHideTool();"><table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0"><tr><td width="99%" moveType="m">&nbsp;<font color="#FFFFFF" moveType="m">' + this.Caption + '</font></td><td width="1%"><img id="'+this.ID+'_img" title="单击收缩工具栏" src="../../../js/design/image/' + this.TitleBtn[1] + '.gif" style="cursor:hand;" onclick="'+this.ID+'.showHideTool();" height="14" width="14" border="0"></td></tr></table></td></tr>' +
