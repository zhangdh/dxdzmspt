...
<html>
	<head>
		...
		<script type="text/javascript" src="userListLdps.js"></script>
		<title>下一步处理选择列表</title>
	</head>
	<body>
	<div id="selectYh" class="easyui-window"   closed="close" title="选择下一步处理人" closable = "false" collapsible="close" 
				minimizable="close" maximizable="close"  modal="true" style="width:530px;height:380px; left:1px;top:1px">
		<div class="easyui-layout" style="width:100%;height:300px;">
			<div region="west"   style="width:250px;" title="选择处理人">
				<ul id="usertree" name="usertree" class="ztree"></ul>
			</div>
			<div region="center"  id="yxz" title="选择领导呈送批示">
				<ul id="ldtree" name="ldtree" class="ztree"></ul>
			</div>
		</div>
		<br/>
