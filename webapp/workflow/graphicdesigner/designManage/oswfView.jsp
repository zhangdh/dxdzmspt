...
<script charset="utf-8"  src="${webcontext}/workflow/design/js/js/common.js"></script>
<script  charset="utf-8"  src="${webcontext}/workflow/design/js/js/dtree.js"></script>
<script charset="utf-8"   src="${webcontext}/workflow/design/js/js/shape.js"></script>
<script charset="utf-8"  src="${webcontext}/workflow/design/js/js/toppanel.js"></script>
<script charset="utf-8" src="${webcontext}/workflow/design/js/js/topflow.js"></script>
<script charset="utf-8" src="${webcontext}/workflow/design/js/js/topflowevent.js"></script>
<script charset="utf-8"  src="${webcontext}/workflow/design/js/js/contextmenu.js"></script>
