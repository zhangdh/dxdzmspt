...
<link href="${webcontext}/js/design/css/style.css" type="text/css" rel="stylesheet">
<script charset="utf-8"  src="${webcontext}/js/design/js/common.js"></script>
<script  charset="utf-8"  src="${webcontext}/js/design/js/dtree.js"></script>
<script charset="utf-8"   src="${webcontext}/js/design/js/shape.js"></script>
<script charset="utf-8"  src="${webcontext}/js/design/js/toppanel.js"></script>
<script charset="utf-8" src="${webcontext}/js/design/js/topflow.js"></script>
<script charset="utf-8" src="${webcontext}/js/design/js/topflowevent.js"></script>
<script charset="utf-8"  src="${webcontext}/js/design/js/contextmenu.js"></script>
...
function mnuSaveFlow(){ 
 ...
 // alert('在asp环境下才能保存！');//--
  //return false;                  //--
  //alert(_FLOW.FileName.replace(/\s/g,""));
 var s = _FLOW.validate();
 if(s != ""){
    alert(s);
  	return;  
 }
 if(_FLOW.FileName.replace(/\s/g,"")==""){
