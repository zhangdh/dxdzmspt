...
public class NamedParameterJdbcTemplate implements NamedParameterJdbcOperations {
	...
	public Object execute(String sql, SqlParameterSource paramSource,
			PreparedStatementCallback action) throws DataAccessException {
		return getJdbcOperations().execute(
				getPreparedStatementCreator(sql, paramSource), action);
	}

	public Object execute(String sql, Map paramMap,
			PreparedStatementCallback action) throws DataAccessException {
		return execute(sql, new MapSqlParameterSource(paramMap), action);
	}

	public Object query(String sql, SqlParameterSource paramSource,
			ResultSetExtractor rse) throws DataAccessException {
		return getJdbcOperations().query(
				getPreparedStatementCreator(sql, paramSource), rse);
	}

	public Object query(String sql, Map paramMap, ResultSetExtractor rse)
	...
	public void query(String sql, SqlParameterSource paramSource,
		...
		getJdbcOperations().query(
				getPreparedStatementCreator(sql, paramSource), rch);
	}
	...
	public List query(String sql, SqlParameterSource paramSource,
		...
		return getJdbcOperations().query(
				getPreparedStatementCreator(sql, paramSource), rowMapper);
	}
	...
	public Object queryForObject(String sql, SqlParameterSource paramSource,
			RowMapper rowMapper) throws DataAccessException {
		List results = getJdbcOperations().query(
				getPreparedStatementCreator(sql, paramSource), rowMapper);
	...
	public Object queryForObject(String sql, Map paramMap, RowMapper rowMapper)
			throws DataAccessException {
		return queryForObject(sql, new MapSqlParameterSource(paramMap),
				rowMapper);
	}

	public Object queryForObject(String sql, SqlParameterSource paramSource,
			Class requiredType) throws DataAccessException {
		return queryForObject(sql, paramSource, new SingleColumnRowMapper(
				requiredType));
	}

	public Object queryForObject(String sql, Map paramMap, Class requiredType)
			throws DataAccessException {
		return queryForObject(sql, paramMap, new SingleColumnRowMapper(
				requiredType));
	}
	...
	public SqlRowSet queryForRowSet(String sql, Map paramMap)
			throws DataAccessException {
	...
	public int update(String sql, SqlParameterSource paramSource,
		...
		Object[] params = NamedParameterUtils.buildValueArray(parsedSql,
				paramSource, null);
		int[] paramTypes = NamedParameterUtils.buildSqlTypeArray(parsedSql,
				paramSource);
		...
		return getJdbcOperations().update(
				pscf.newPreparedStatementCreator(params), generatedKeyHolder);
	}
	...
	public String sqltoUse(String sql, SqlParameterSource paramSource) {
		ParsedSql parsedSql = getParsedSql(sql);
		String sqlToUse = NamedParameterUtils.substituteNamedParameters(
				parsedSql, paramSource);
		return sqlToUse;
	...
	public Object[] maptoObject(String sql, SqlParameterSource paramSource) {
		ParsedSql parsedSql = getParsedSql(sql);
		Object[] params = NamedParameterUtils.buildValueArray(parsedSql,
				paramSource, null);
		return params;
