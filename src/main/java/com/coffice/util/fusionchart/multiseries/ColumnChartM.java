...
public class ColumnChartM {
	 ...
	 */
	public ColumnChartM(List categoriesList,String column){
		xmlStr = new StringBuffer("<chart caption=\"\" shownames=\"1\" showvalues=\"1\" decimals=\"0\" useRoundEdges=\"1\">");
	 ...
	 */
	public ColumnChartM(String titleListStr){
	 ...
	 */
	public void dataSet(List dataList,String column,String seriesName){
