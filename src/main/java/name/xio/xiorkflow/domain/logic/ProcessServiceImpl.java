...
public class ProcessServiceImpl implements ProcessService {
    ...
    public ProcessServiceImpl() {
        ...
        //20081120增加os的输出目录
        //this.setOsBaseDir(ProcessServiceImpl.OS_BASE_DIR);
        this.setOsxslName(ProcessServiceImpl.OS_XSL_NAME);
        init();
    }
    ...
    public void init(){
    	try {
    		this.setBaseDirName(SysPara.getValue("oswf_xiorkflow_xmlpath"));
    		this.setOsBaseDir(SysPara.getValue("oswf_xmlpath"));
		} catch (Exception e) {
    ...
    public List listProcess() {
    	init();
        File baseDir = new File(this.getBaseDirName());
    ...
    public String BASE_DIR_NAME = "";//"oswf\\resources\\processes";

    public final static String DEFAULT_FILE_NAME = "default";

    public final static String FILE_TYPE = "xml";
    
    public String OS_BASE_DIR ="";//"WEB-INF\\classes"; //"osProcesses";
    
    public final static String OS_XSL_NAME = "defaultxsl.xsl";
    
    public final static String DTD_BASE_DIR="WEB-INF\\classes";//DTD文件所有路径
    ...
    private String osxslName;
    private String osBaseDir;
	public String getOsBaseDir() {
		return osBaseDir;
	}

	public void setOsBaseDir(String osBaseDir) {
		this.osBaseDir = osBaseDir;
	}

	public String getOsxslName() {
		return osxslName;
	}

	public void setOsxslName(String osxslName) {
		this.osxslName = osxslName;
	}
